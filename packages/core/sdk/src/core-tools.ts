        ...
        tool({
          ...
          execute: (input: typeof OAuthProbeInput.Type, { ctx }) =>
            Effect.map(ctx.oauth.probe({ url: input.url }), (result) => ({
              ...
              supportsEnterpriseManagedAuthorization: result.supportsEnterpriseManagedAuthorization,
              authorizationGrantProfilesSupported: result.authorizationGrantProfilesSupported,
            })),
        }),
        tool({
          name: "oauth.start",
