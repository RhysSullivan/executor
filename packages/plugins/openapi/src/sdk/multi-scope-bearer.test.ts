  ...
  it.effect(
    ...
    () =>
      Effect.gen(function* () {
        ...
        yield* removeOpenApiCredentialBinding(aliceExec, {
          sourceId: "vercel",
          sourceScope: String(orgScope.id),
          slotKey: "auth:token",
          targetScope: String(aliceScope.id),
        });
        ...
        const bindingsAfterReadd = yield* listOpenApiCredentialBindings(aliceExec, {
          sourceId: "vercel",
          sourceScope: String(orgScope.id),
        });
