...
export const openapi_source = pgTable(
  ...
  (table) => [uniqueIndex("openapi_source_scope_id_id_uidx").on(table.scope_id, table.id)],
);
...
export const openapi_operation = pgTable(
  ...
  (table) => [uniqueIndex("openapi_operation_scope_id_id_uidx").on(table.scope_id, table.id)],
);
...
export const openapi_source_header = pgTable(
  ...
  (table) => [uniqueIndex("openapi_source_header_scope_id_id_uidx").on(table.scope_id, table.id)],
);
...
export const openapi_source_spec_fetch_query_param = pgTable(
  ...
  (table) => [
    uniqueIndex("openapi_source_spec_fetch_query_param_scope_id_id_uidx").on(
      table.scope_id,
      table.id,
    ),
  ],
...
export const mcp_source = pgTable(
  ...
  (table) => [uniqueIndex("mcp_source_scope_id_id_uidx").on(table.scope_id, table.id)],
);
...
export const mcp_source_header = pgTable(
  ...
  (table) => [uniqueIndex("mcp_source_header_scope_id_id_uidx").on(table.scope_id, table.id)],
);
...
export const mcp_source_query_param = pgTable(
  ...
  (table) => [uniqueIndex("mcp_source_query_param_scope_id_id_uidx").on(table.scope_id, table.id)],
);
...
export const mcp_binding = pgTable(
  ...
  (table) => [uniqueIndex("mcp_binding_scope_id_id_uidx").on(table.scope_id, table.id)],
);
...
export const graphql_source = pgTable(
  ...
  (table) => [uniqueIndex("graphql_source_scope_id_id_uidx").on(table.scope_id, table.id)],
);
...
export const graphql_source_header = pgTable(
  ...
  (table) => [uniqueIndex("graphql_source_header_scope_id_id_uidx").on(table.scope_id, table.id)],
);
...
export const graphql_operation = pgTable(
  ...
  (table) => [uniqueIndex("graphql_operation_scope_id_id_uidx").on(table.scope_id, table.id)],
);
